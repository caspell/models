...
train_checkpoint = '/home/mhkim/data/convolution_train/'
...
def main(_):
  ...
  with tf.Session() as sess:
    ...
    writer = tf.train.SummaryWriter("/tmp/tensorflow-convolution", sess.graph)

    saver.save(sess=sess, save_path=os.path.join(train_checkpoint, 'convolution.ckpt'))
